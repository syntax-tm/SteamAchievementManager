...
namespace SAM.API
{
    public static class EnumExtensions
    {
        internal static string GetDisplayName(this Enum value)
        {
            ...
            if (display != null)
            {
                if (!string.IsNullOrEmpty(display.Name)) return display.Name;
                if (!string.IsNullOrEmpty(display.ShortName)) return display.ShortName;
                if (!string.IsNullOrEmpty(display.Description)) return display.Description;
            }
