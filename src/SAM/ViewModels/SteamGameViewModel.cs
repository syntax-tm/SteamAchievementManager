...
namespace SAM.ViewModels
{
    ...
    public partial class SteamGameViewModel
    {
        ...
        public int SaveAchievements()
        {
            ...
            try
            {
                var modified = Enumerable.Where<SteamAchievement>(Achievements!, a => a.IsModified).ToList();
                if (!modified.Any())
                {
        ...
        public int SaveStats()
        {
            ...
            try
            {
                var modified = Enumerable.Where<SteamStatisticBase>(Statistics!, a => a.IsModified).ToList();
                if (!modified.Any())
                {
        ...
        protected void OnManagerIsModifiedChanged()
        {
            ...
            AllowUnlockAll = Enumerable.Any<SteamAchievement>(Achievements!, a => !a.IsAchieved);
        }
