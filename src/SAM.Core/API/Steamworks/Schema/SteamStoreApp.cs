...
public class SteamStoreMovie
{
	...
	[JsonProperty("webm")]
	public SteamStoreMovieInfo WebM
	{
		get; set;
	}

	[JsonProperty("mp4")]
	public SteamStoreMovieInfo MP4
	{
		get; set;
	}
...
public class SteamStoreApp
{
	...
	public object PcRequirements
	{
		get; set;
	}

	[JsonProperty("mac_requirements")]
	public object MacRequirements
	{
		get; set;
	}

	[JsonProperty("linux_requirements")]
	public object LinuxRequirements
	{
		get; set;
	}
	...
	public List<SteamStoreMovie> Movies
	{
		get; set;
	}
